...
import { MyRequestsComponent, AddWorkOnRequestDialog, WorksOnRequestInfoDialog, CompleteRequestDialog, RefuseRequestDialog } from '../my-requests/my-requests.component';
